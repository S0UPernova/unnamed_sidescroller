...
export default function Canvas(props: any) {
  ...
  useEffect(() => {
    ...
    const platform = gameObjectFactory({ x: (canvas.width / 8) + 200, y: canvas.height - (canvas.height / 4), height: 50, width: 200, color: "#050", shape: "rectangle", collisions: { bottom: false } })
